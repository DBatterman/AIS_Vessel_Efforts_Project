...
d3.json("/get-data", function(error, data) {
    ...
    d3.json("/get-metrics", function(error, data) {
        ...
        var content2 = document.createTextNode(`All Vessels: Max - ${Math.max(...all)} vessels, increasing an average of ${(metrics["Total"]["Slope"] * multiplier).toFixed(0)} vessels. `);
        var content3 = document.createTextNode(`Fishing Vessels: Max - ${Math.max(...fish)} vessels, increasing an average of ${(metrics["Fishing"]["Slope"] * multiplier).toFixed(0)} vessels. `);
        var content4 = document.createTextNode(`Tug/Tow Vessels: Max - ${Math.max(...tug)} vessels, increasing an average of ${(metrics["TugTow"]["Slope"] * multiplier).toFixed(0)} vessels.`);
        var content5 = document.createTextNode(`Recreational Vessels: Max - ${Math.max(...rec)} vessels, increasing an average of ${(metrics["Recreational"]["Slope"] * multiplier).toFixed(0)} vessels. `);
        var content6 = document.createTextNode(`Passenger Vessels: Max - ${Math.max(...pass)} vessels, increasing an average of ${(metrics["Passenger"]["Slope"] * multiplier).toFixed(0)} vessels. `);
        var content7 = document.createTextNode(`Cargo Vessels: Max - ${Math.max(...cargo)} vessels, increasing an average of ${(metrics["Cargo"]["Slope"] * multiplier).toFixed(0)} vessels. `);
        var content8 = document.createTextNode(`Tanker Vessels: Max - ${Math.max(...tanker)} vessels, increasing an average of ${(metrics["Tanker"]["Slope"] * multiplier).toFixed(0)} vessels. `);
        var content9 = document.createTextNode(`Other Vessels: Max - ${Math.max(...other)} vessels, increasing an average of ${(metrics["Other"]["Slope"] * multiplier).toFixed(0)} vessels. `);
