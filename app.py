...
## ML Linear Regression Model
        ...
        for boat_type in types:
            if boat_type == "Fishing":
                ais_graphs2(boat_type,"fishing_best_model")
            elif boat_type == "TugTow":
                ais_graphs2(boat_type,"tugtow_best_model")
            elif boat_type == "Recreational":
                ais_graphs2(boat_type,"recreational_best_model")
            elif boat_type == "Passenger":
                ais_graphs2(boat_type,"passenger_best_model")
            elif boat_type == "Cargo":
                ais_graphs2(boat_type,"cargo_best_model")
            elif boat_type == "Tanker":
                ais_graphs2(boat_type,"tanker_best_model")
            elif boat_type == "Other":
                ais_graphs2(boat_type,"other_best_model")
            elif boat_type == "Unavailable":
                ais_graphs2(boat_type,"unavailable_best_model")
            else:
                ais_graphs2(boat_type,"total_best_model")
